...
fn main() {
    ...
    // emprestimo_borrow não pode apontar para o valor da string Cristian pois teriamos DUAS variáveis
    // apontando para o mesmo local e o compilador não saberia quem é responsável pela limpeza
    // Se ocorresse a limpeza, emprestimo_borrow apontaria para o Null ou seria um Dangling Pointer.
